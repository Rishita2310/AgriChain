...
export default function EscrowPaymentView({
  ...
  useEffect(() => {
    if (isTxConfirmed && txHash && !isProcessing) {
      ...
      onPaymentSuccess(txHash, ethEquivalent, ethRate);
    }
  ...
  const handlePayClick = async () => {
    ...
    try {
      ...
      setTxHash(hash);
      toast.loading('Transaction submitted! Waiting for blockchain confirmation...', { id: 'tx-toast' });
      ...
      <div className="w-full lg:w-[450px] space-y-6">
        ...
        <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100">
          <div className="flex justify-between items-center mb-4">
            ...
            <span className={`text-xs font-bold px-2.5 py-1 rounded-full flex items-center gap-1.5 ${isConnected ? 'bg-emerald-50 text-emerald-700 border border-emerald-200' : 'bg-rose-50 text-rose-700 border border-rose-200'
              }`}>
